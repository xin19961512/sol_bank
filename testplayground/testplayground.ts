...
// export ANCHOR_PROVIDER='{"cluster":"https://custom-rpc-url.com","wallet":"/path/to/custom/wallet.json"}'
...
describe("solana_bridge", () => {
  ...
  // const mintpk = new anchor.web3.PublicKey("GhiWGvtkvUzzJPx3mq32QDjh6cW9ZYzRyfBu5pEm5yUL"); // token
